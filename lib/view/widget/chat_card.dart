...
class ChatCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<StorageCtrl>(builder: (sharePrefNotifier) {
      if (sharePrefNotifier.userDetails['user_name'] == snap['send_by']) {
        boxDecoration = BoxDecoration(
          color: Theme.of(context).brightness == Brightness.light
              ? const Color.fromARGB(31, 102, 102, 102)
        ...
        boxDecoration = const BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: [
              Color.fromARGB(255, 221, 203, 242),
              Color.fromARGB(255, 207, 214, 243)
            ],
